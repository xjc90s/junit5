...
* *Artifact IDs*:
  ...
  `junit-platform-configuration-api`::
    Annotations for documenting configuration parameters for test engines and JUnit Jupiter extensions.
  `junit-platform-configuration-processor`::
    Annotations processor to generate a machine-readable overview of configuration parameters.
