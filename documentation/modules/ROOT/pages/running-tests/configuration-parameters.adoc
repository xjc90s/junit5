...
The following lists enumerate the configuration parameters supported by the JUnit Platform,
Jupiter, and Vintage.

NOTE: Third-party JUnit Platform test engines and JUnit Jupiter extensions may provide additional configuration parameters.

include::partial$configuration-parameters-lists.adoc[]
